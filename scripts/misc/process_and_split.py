...
parser.add_argument("-s", "--split", help="proportion for validation set", required=False, type=float, default=0.5)
...
if __name__ == "__main__":
    ...
    dev_df.to_csv(os.path.join(args.output, "val.csv"), index=False)